...
const GameSettings = preload("res://addons/wcs_asset_core/resources/configuration/game_settings.gd")
const UserPreferences = preload("res://addons/wcs_asset_core/resources/configuration/user_preferences.gd")
const SystemConfiguration = preload("res://addons/wcs_asset_core/resources/configuration/system_configuration.gd")
