...
func _get_standard_visibility_flags() -> int:
	...
	return (
		HUDConfig.GAUGE_SPEED |
		HUDConfig.GAUGE_WEAPONS |
		HUDConfig.GAUGE_OBJECTIVES |
		HUDConfig.GAUGE_TARGET_BOX |
		HUDConfig.GAUGE_TARGET_SHIELD |
		HUDConfig.GAUGE_PLAYER_SHIELD |
		HUDConfig.GAUGE_AFTERBURNER |
		HUDConfig.GAUGE_WEAPON_ENERGY |
		HUDConfig.GAUGE_AUTO_SPEED |
		HUDConfig.GAUGE_AUTO_TARGET |
		HUDConfig.GAUGE_CMEASURE |
		HUDConfig.GAUGE_TALKING_HEAD |
		HUDConfig.GAUGE_DAMAGE |
		HUDConfig.GAUGE_MESSAGE_LINES |
		HUDConfig.GAUGE_RADAR |
		HUDConfig.GAUGE_ESCORT |
		HUDConfig.GAUGE_DIRECTIVES |
		HUDConfig.GAUGE_THREAT |
		HUDConfig.GAUGE_LEAD |
		HUDConfig.GAUGE_LOCK |
		HUDConfig.GAUGE_LEAD_SIGHT |
		HUDConfig.GAUGE_ORIENTATION_TEE
	)
...
func _get_widescreen_visibility_flags() -> int:
	...
	return _get_standard_visibility_flags() | (
		HUDConfig.GAUGE_SQUADMSG |
		HUDConfig.GAUGE_LAG |
		HUDConfig.GAUGE_MINI_TARGET_BOX |
		HUDConfig.GAUGE_OFFSCREEN |
		HUDConfig.GAUGE_BRACKETS |
		HUDConfig.GAUGE_WEAPON_LINKING
	)
