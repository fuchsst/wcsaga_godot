...
func _setup_element_mappings() -> void:
	element_flag_mapping = {
		# Core HUD elements
		"speed": HUDConfigExtended.GAUGE_SPEED,
		"weapons": HUDConfigExtended.GAUGE_WEAPONS,
		"objectives": HUDConfigExtended.GAUGE_OBJECTIVES,
		"target_box": HUDConfigExtended.GAUGE_TARGET_BOX,
		"target_shield": HUDConfigExtended.GAUGE_TARGET_SHIELD,
		"player_shield": HUDConfigExtended.GAUGE_PLAYER_SHIELD,
		"afterburner": HUDConfigExtended.GAUGE_AFTERBURNER,
		"weapon_energy": HUDConfigExtended.GAUGE_WEAPON_ENERGY,
		"auto_speed": HUDConfigExtended.GAUGE_AUTO_SPEED,
		"auto_target": HUDConfigExtended.GAUGE_AUTO_TARGET,
		"cmeasure": HUDConfigExtended.GAUGE_CMEASURE,
		"talking_head": HUDConfigExtended.GAUGE_TALKING_HEAD,
		"damage": HUDConfigExtended.GAUGE_DAMAGE,
		"message_lines": HUDConfigExtended.GAUGE_MESSAGE_LINES,
		"radar": HUDConfigExtended.GAUGE_RADAR,
		"escort": HUDConfigExtended.GAUGE_ESCORT,
		"directives": HUDConfigExtended.GAUGE_DIRECTIVES,
		"threat": HUDConfigExtended.GAUGE_THREAT,
		"lead": HUDConfigExtended.GAUGE_LEAD,
		"lock": HUDConfigExtended.GAUGE_LOCK,
		"lead_sight": HUDConfigExtended.GAUGE_LEAD_SIGHT,
		"orientation_tee": HUDConfigExtended.GAUGE_ORIENTATION_TEE,
		"squadmsg": HUDConfigExtended.GAUGE_SQUADMSG,
		"lag": HUDConfigExtended.GAUGE_LAG,
		"mini_target_box": HUDConfigExtended.GAUGE_MINI_TARGET_BOX,
		"offscreen": HUDConfigExtended.GAUGE_OFFSCREEN,
		"brackets": HUDConfigExtended.GAUGE_BRACKETS,
		"weapon_linking": HUDConfigExtended.GAUGE_WEAPON_LINKING,
		"throttle": HUDConfigExtended.GAUGE_THROTTLE,
		"radar_integrity": HUDConfigExtended.GAUGE_RADAR_INTEGRITY,
		"countermeasures": HUDConfigExtended.GAUGE_COUNTERMEASURES,
		"wingman_status": HUDConfigExtended.GAUGE_WINGMAN_STATUS,
		"kill_gauge": HUDConfigExtended.GAUGE_KILL_GAUGE,
		"text_warnings": HUDConfigExtended.GAUGE_TEXT_WARNINGS,
		"center_reticle": HUDConfigExtended.GAUGE_CENTER_RETICLE,
		"navigation": HUDConfigExtended.GAUGE_NAVIGATION,
		"mission_time": HUDConfigExtended.GAUGE_MISSION_TIME,
		"flight_path": HUDConfigExtended.GAUGE_FLIGHT_PATH,
		"warhead_count": HUDConfigExtended.GAUGE_WARHEAD_COUNT,
		"support_view": HUDConfigExtended.GAUGE_SUPPORT_VIEW
	}
...
func _load_default_visibility() -> void:
	current_visibility_flags = HUDConfigExtended.DEFAULT_FLAGS
...
func set_element_visibility(element_id: String, visible: bool) -> void:
	...
	var default_visible = (HUDConfigExtended.DEFAULT_FLAGS & flag_bit) != 0
...
func reset_to_defaults() -> void:
	apply_visibility_flags(HUDConfigExtended.DEFAULT_FLAGS)
...
func get_element_info(element_id: String) -> Dictionary:
	...
	var is_default = (HUDConfigExtended.DEFAULT_FLAGS & flag_bit) != 0
...
func get_visibility_summary() -> Dictionary:
	...
	return {
		...
		"default_flags": HUDConfigExtended.DEFAULT_FLAGS,
