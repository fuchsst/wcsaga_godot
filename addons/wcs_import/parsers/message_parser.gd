		...
		if current_section == "#Personas":
			...
			if line.begins_with("$Name:"):
				...
				if not current_msg_name.is_empty():
					_commit_message(personas, current_msg_name, current_msg_text, current_msg_avi, current_msg_wave, current_msg_persona)
...
func _commit_message(personas: Dictionary, msg_name: String, text: String, avi: String, wave: String, persona_name: String) -> void:
